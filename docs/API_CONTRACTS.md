...
| POST `/cargos`                                 | clientId, service, amount, dueDate, required          | cargo pendiente / admin                                                                                   |
...
| POST `/cargos/cancelar`, `/descargos/cancelar` | id                                                    | autorización cancelada sin movimientos / admin                                                            |
